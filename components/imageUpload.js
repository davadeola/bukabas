  ...
  render() {
    return (<div className="col-md-12 text-center">
      ...
      <div className="image-upload text-center">
        {
          this.state.image
            ? <img src="/static/images/tick.png" className="profile-img"/>
            : <label htmlFor="file-input">
                <img src="/static/images/placeHolder.png" className="profile-img"/>
              </label>
        }
        <input type="file" onChange={this.handleChange} className="form-control-file" required="required" id="file-input"/>
      </div>

      <div className="progress">
        <div style={{
            width: this.state.progress + '%'
          }} aria-valuenow={this.state.progress} aria-valuemin="0" aria-valuemax="100" className="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar"></div>
      </div>
